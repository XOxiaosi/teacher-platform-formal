...
export function Workflows({ page, actions, modelSettings, assistantContent }: {
  page: string; actions: PreviewActions; modelSettings?: ReactNode; assistantContent?: ReactNode;
}) {
  if (page === 'agent') {
