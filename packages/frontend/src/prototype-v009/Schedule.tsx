...
export function SchedulePage({ data, setData, notify, request }: StudioProps & { request?: ScheduleRequest }) {
  ...
  return <section className="v9-schedule" aria-label="日程安排">
    <header className="v9-schedule__head"><div><p className="v9-schedule__eyebrow">北京时间 · 2026 年 9 月</p><h1>日程安排</h1></div><button className="v9-button" onClick={() => openAdd()}><Icon name="schedule" />增加课程</button></header>
