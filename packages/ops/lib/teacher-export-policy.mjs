...
export const EXPORT_POLICY = {
  ...
  LessonLedgerEntry: { source: 'teacher_db',
    fields: ["id","teacherId","studentId","entryType","lessonDelta","amount","reasonCiphertext","paymentId","lessonId","adjustmentConfirmationId","statusCorrectionConfirmationId","clientRequestId","createdAtTs"],
    exclude: [], relations: ["student","payment","lesson","adjustmentConfirmation","statusCorrectionConfirmation","completionSnapshot"],
  },
  ...
  LessonStatusCorrectionConfirmation: { source: 'teacher_db',
    fields: ["id","teacherId","lessonId","studentId","fromStatus","toStatus","reasonCiphertext","clientRequestId","status","expectedLessonUpdatedAtTs","confirmedAtTs","createdAtTs","updatedAtTs"],
    exclude: [], relations: ["student","lesson","ledgerEntry"],
  },
  ...
  ParentFeedback: { source: 'teacher_db',
    ...
    exclude: [], relations: ["student","lesson","contextSnapshot","generationTask"],
  },
  FeedbackDraftTask: { source: 'teacher_db',
    fields: ["id","teacherId","studentId","clientRequestId","requestFingerprint","status","version","attemptCount","retryable","requestCiphertext","draftCiphertext","generationCiphertext","errorCiphertext","savedFeedbackId","createdAtTs","updatedAtTs"],
    exclude: [], relations: ["student","savedFeedback","attempts"],
  },
  FeedbackDraftAttempt: { source: 'teacher_db',
    fields: ["id","taskId","teacherId","clientRequestId","requestFingerprint","status","modelCallStartedAtTs","modelCallEndedAtTs","resultCiphertext","errorCiphertext","createdAtTs","updatedAtTs"],
    exclude: [], relations: ["task"],
  },
  ...
  Student: { source: 'teacher_db',
    ...
    exclude: [], relations: ["schedules","scheduleParticipants","recurrenceRuleParticipants","lessons","payments","lessonLedgerEntries","lessonLedgerAdjustmentConfirmations","lessonStatusCorrectionConfirmations","completionSnapshots","parentFeedbacks","feedbackDraftTasks","studentRecords","studentSourceRecords"],
  },
  ...
  Lesson: { source: 'teacher_db',
    ...
    exclude: [], relations: ["student","schedule","parentFeedbacks","lessonLedgerEntries","completionSnapshots","lessonStatusCorrectionConfirmations"],
  },
};
