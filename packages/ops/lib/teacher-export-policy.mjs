...
export const EXPORT_POLICY = {
  ...
  Student: { source: 'teacher_db',
    ...
    exclude: [], relations: ["schedules","scheduleParticipants","recurrenceRuleParticipants","lessons","payments","lessonLedgerEntries","lessonLedgerAdjustmentConfirmations","completionSnapshots","parentFeedbacks","feedbackDraftTasks","studentRecords","studentSourceRecords"],
  },
